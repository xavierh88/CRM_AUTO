...
const resources = {
  en: {
    translation: {
      ...
      "nav.demoActive": "Demo mode active",
      "nav.admin": "Administrator",
      "nav.bdcManager": "BDC Manager",
      "nav.bdc": "BDC",
      "nav.telemarketer": "Telemarketer",
      ...
      "auth.name": "Full Name",
      "auth.phone": "Phone",
      "auth.welcome": "Welcome to DEALER AI OS",
      "auth.subtitle": "Manage your clients and appointments efficiently",
      "auth.or": "Or",
      "auth.demoMode": "Demo Mode",
      "auth.demoActivated": "Demo mode activated",
      "auth.demoNotice": "Fictional data • No real actions • Isolated environment",
      ...
      "jarvis.description": "AI-powered dealership assistant",
      "jarvis.tools": "Tools",
      "jarvis.availableTools": "Available Tools",
      "jarvis.chat": "Chat",
      "jarvis.history": "History",
      "jarvis.howCanIHelp": "How can I help?",
      "jarvis.askAbout": "Ask me about leads, appointments, inventory, deals, or reports.",
      "jarvis.clearChat": "Clear",
      "jarvis.confirmAction": "Confirm Action",
      "jarvis.executeAction": "Execute this action?",
      "jarvis.toolCalls": "Tool calls",
      "jarvis.actionCompleted": "Action completed",
      "jarvis.actionCancelled": "Action cancelled",
      "jarvis.actionCompletedDemo": "Action completed (demo)",
      "jarvis.poweredBy": "Powered by Dealer AI OS",
      "jarvis.newLine": "new line",
      "jarvis.historyPlaceholder": "Previous conversations will appear here",
  ...
  es: {
    translation: {
      ...
      "nav.demoActive": "Modo demo activo",
      "nav.admin": "Administrador",
      "nav.bdcManager": "Gerente BDC",
      "nav.bdc": "BDC",
      "nav.telemarketer": "Telemarketer",
      "nav.sectionCore": "Principal",
      "nav.sectionAnalytics": "Analíticas",
      "nav.sectionAI": "IA",
      ...
      "auth.phone": "Teléfono",
      "auth.welcome": "Bienvenido a DEALER AI OS",
      "auth.subtitle": "Gestiona tus clientes y citas eficientemente",
      "auth.or": "O",
      "auth.demoMode": "Modo Demo",
      "auth.demoActivated": "Modo demo activado",
      "auth.demoNotice": "Datos ficticios • Sin acciones reales • Entorno aislado",
      ...
      "dashboard.actionItems": "acciones pendientes",
      ...
      "jarvis.description": "Asistente inteligente de concesionaria",
      "jarvis.tools": "Herramientas",
      "jarvis.availableTools": "Herramientas Disponibles",
      "jarvis.chat": "Chat",
      "jarvis.history": "Historial",
      "jarvis.howCanIHelp": "¿Cómo puedo ayudarte?",
      "jarvis.askAbout": "Pregúntame sobre leads, citas, inventario, negocios o reportes.",
      "jarvis.clearChat": "Limpiar",
      "jarvis.confirmAction": "Confirmar Acción",
      "jarvis.executeAction": "¿Ejecutar esta acción?",
      "jarvis.toolCalls": "Llamadas a herramientas",
      "jarvis.actionCompleted": "Acción completada",
      "jarvis.actionCancelled": "Acción cancelada",
      "jarvis.actionCompletedDemo": "Acción completada (demo)",
      "jarvis.poweredBy": "Impulsado por Dealer AI OS",
      "jarvis.newLine": "nueva línea",
      "jarvis.historyPlaceholder": "Las conversaciones anteriores aparecerán aquí",
