...
class CRMAPITester:
    def __init__(self, base_url="https://autosales-manager-1.preview.emergentagent.com/api"):
...
def main():
    ...
    # NEW DOCUMENT UPLOAD/DOWNLOAD TESTS (Priority High) - Run after client creation
    print("\n" + "="*50)
